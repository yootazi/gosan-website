    ...
    <main data-screen-label="حمایت از گوسان">
      ...
      <div className="wrap" style={{ maxWidth: '760px', paddingBottom: '5rem' }}>
        <Reveal>
          ...
          <p style={note}>
            برآورد نیاز سالانهٔ گاهنامه و اندیشکده حدود ۶۵ هزار یورو است: نزدیک به ۳۷ درصد آن یکراست به عنوان حق‌التحریر به نویسندگان و پژوهشگران می‌رسد؛ حدود ۲۲ درصد دستمزد تحریریه و مدیریت است؛ حدود ۲۲ درصد کارهای پروژه‌ای پشتیبانی، ویرایش و ترجمه؛ و تنها حدود ۴ درصد هزینه‌های فنی (میزبانی و ابزارها). باقی، اندوختهٔ احتیاطی است. منابع مالی سالانه اعلام می‌شود.
          </p>
