    ...
    <main data-screen-label="حمایت از گوسان">
      ...
      <div className="wrap" style={{ maxWidth: '760px', paddingBottom: '5rem' }}>
        <Reveal>
          ...
          <p style={note}>
            برآورد نیاز سالانهٔ گاهنامه و اندیشکده حدود ۶۵ هزار یورو است: حق‌التحریر نوشتارها و مقاله‌های پژوهشی، دستمزد تحریریه و هزینه‌های فنی (میزبانی، ابزارها). منابع مالی سالانه اعلام می‌شود.
          </p>
