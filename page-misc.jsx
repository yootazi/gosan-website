  ...
  return (
    <main data-screen-label="حمایت از گوسان">
      ...
      <div className="wrap" style={{ maxWidth: '760px', paddingBottom: '5rem' }}>
        <Reveal>
          <p style={para}>
            گوسان نه آگهی و نه بودجه‌ای از جایی می‌پذیرد. هزینهٔ گاهنامه و اندیشکده (حق‌التحریر نویسندگان و پژوهشگران، دستمزد تحریریه و هزینه‌های فنی)، یکسره از کمک‌های مردمی تأمین می‌شود. هیچ حامی‌ای بر محتوا اثر نمی‌گذارد و هیچ یافته‌ای را پیش از انتشار نمی‌بیند.
          </p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '0.9rem', margin: '0 0 1rem' }}>
            {[
              ...
              { amt: 100, what: 'هر سال هزینهٔ یک مقالهٔ کامل اندیشکده و حق‌التحریر پژوهشگران آن را می‌پردازد.' },
            ].map((t) => {
          ...
          <p style={note}>
            برآورد نیاز سالانهٔ گاهنامه و اندیشکده حدود ۶۵ هزار یورو است: نزدیک به ۳۷ درصد آن یکراست به عنوان حق‌التحریر به نویسندگان و پژوهشگران می‌رسد؛ حدود ۲۲ درصد دستمزد تحریریه و مدیریت است؛ حدود ۲۲ درصد کارهای پروژه‌ای پشتیبانی، ویرایش و ترجمه؛ و تنها حدود ۴ درصد هزینه‌های فنی (میزبانی و ابزارها). باقی، اندوختهٔ احتیاطی است. این رقم، بودجهٔ مرحلهٔ بنیان‌گذاری است: گوسان برنامهٔ مالی پانزده‌سالهٔ خود را در سه مرحله تعریف کرده است؛ رشد هر مرحله تنها بر پایهٔ منابع پایدار به‌دست‌آمده آغاز می‌شود و هزینه‌های ثابت هرگز از درآمد پایدار پیشی نمی‌گیرند. منابع مالی سالانه اعلام می‌شود.
          </p>
