...
const GOSAN_BOARD = [
  { key: 'hafez', name: 'حافظ باباشاهی', role: 'هیئت تحریریه', craft: 'پیانیست، مدرس موسیقی', img: 'assets/board-hafez.png',
    bio: 'پیانیست و مدرس موسیقی؛ نویسندهٔ جستارهایی در موسیقی کهن ایران و پیوند دیرینهٔ شعر و نغمه در سنت رامشگری.' },
  { key: 'yalda', name: 'یلدا زمانی', role: 'مدیر مسئول و سردبیر', craft: 'رهبر ارکستر، آهنگساز', img: 'assets/board-yalda.png',
    bio: 'رهبر ارکستر و آهنگساز؛ بنیان‌گذار گاهنامهٔ گوسان و سردبیر نخستین شماره. در پیوند موسیقی و روایت، می‌کوشد صدای میراث کهن ایران را به گوش امروز برساند.' },
  { key: 'ehsan', name: 'احسان شواربی', role: 'مدیر داخلی', craft: 'باستان‌شناس، سکه‌شناس', img: 'assets/board-ehsan.png',
    bio: 'باستان‌شناس و سکه‌شناس؛ پژوهشگر تاریخ و فرهنگ ایران باستان. دلبستهٔ روایت تاریخ از دل نقش‌ها و سکه‌های کهن این سرزمین.' },
