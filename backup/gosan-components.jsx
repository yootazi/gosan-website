...
const GOSAN_POSTS = [
  { slug: 'gosan-narrators', tag: 'جستار', title: 'گوسان‌ها؛ راویان فراموش‌شدهٔ تاریخ و افسانهٔ ایران', excerpt: 'جست‌وجویی در پیشینهٔ رامشگران و نغمه‌خوانان ایران باستان، آنان که تاریخ و افسانه را در جامهٔ زربفت چامه و موسیقی از گزند فراموشی در امان داشتند.', date: 'بهار ۲۵۸۵', author: 'حافظ باباشاهی', full: true },
  { slug: 'miniature-narrative', tag: 'جستار', title: 'نگارگری و روایت؛ از نسخه‌های مصور تا امروز', excerpt: 'نگاهی به پیوند تصویر و قصه در سنت نگارگری ایرانی و آنچه از آن به زبان بصری امروز رسیده است.', date: 'بهار ۲۵۸۵', author: 'امین نایب‌پور' },
  { slug: 'music-interview', tag: 'گفتگو', title: 'گفت‌وگو با پژوهشگر موسیقی کهن ایرانی', excerpt: 'دربارهٔ پیوند شعر و موسیقی در سنت روایتگری ایرانی و آنچه از نغمه‌های باستان به امروز رسیده است.', date: 'بهار ۲۵۸۵', author: 'یلدا زمانی' },
  { slug: 'calligraphy-talk', tag: 'گفتگو', title: 'گفت‌وگو دربارهٔ خوشنویسی و هویت بصری ایرانی', excerpt: 'از قلمِ نی تا حروف امروز؛ خوشنویسی چگونه در زندگی روزمرهٔ ما زنده می‌ماند؟', date: 'بهار ۲۵۸۵', author: 'سهراب لبیب' },
  { slug: 'memorial', tag: 'یادمان', title: 'یادی از بزرگان فرهنگ و هنر ایران', excerpt: 'یادمان چهره‌هایی که در پاسداشت زبان، ادب و هنر ایران کوشیدند و میراثی ماندگار بر جای نهادند.', date: 'بهار ۲۵۸۵', author: 'احسان شواربی' },
  { slug: 'cypress-memory', tag: 'یادمان', title: 'سروهای کهن؛ یادمان باغ و معماری ایرانی', excerpt: 'درنگی بر جای‌گاه سرو در حافظهٔ بصری ایرانیان، از نقش‌برجسته‌های تخت‌جمشید تا باغ‌های کاشان.', date: 'بهار ۲۵۸۵', author: 'حافظ باباشاهی' },
  ...
  { slug: 'modern-poetry', tag: 'جستار', title: 'شعر معاصر و میراثِ کلاسیک', excerpt: 'نگاهی به گفت‌وگوی پنهانِ شاعران نو با سنت هزارسالهٔ شعر فارسی، از نیما تا امروز.', date: 'بهار ۲۵۸۵', author: 'سهراب لبیب' },
  { slug: 'painter-talk', tag: 'گفتگو', title: 'گفت‌وگو با یک نگارگرِ معاصر', excerpt: 'دربارهٔ جای‌گاه نگارگری سنتی در هنر امروز ایران و چالشِ پیوندِ کهنه و نو در زبانِ تصویر.', date: 'بهار ۲۵۸۵', author: 'یلدا زمانی' },
  { slug: 'radif-memorial', tag: 'یادمان', title: 'یادمانِ استادِ ردیفِ موسیقی', excerpt: 'بزرگداشتِ چهره‌ای که عمر در پاسداشت ردیفِ موسیقی دستگاهیِ ایران گذاشت و نسلی را پروراند.', date: 'بهار ۲۵۸۵', author: 'احسان شواربی' },
  { slug: 'silence-music', tag: 'یادداشت آزاد', title: 'در بابِ سکوت در موسیقی ایرانی', excerpt: 'یادداشتی کوتاه دربارهٔ نقشِ سکوت و درنگ در آواز و ردیف؛ آنجا که خاموشی، خود نغمه است.', date: 'بهار ۲۵۸۵', author: 'یلدا زمانی' },
  { slug: 'city-memory', tag: 'یادداشت آزاد', title: 'شهر، حافظه و معماری', excerpt: 'قدم‌زدن در کوچه‌های کهن و این پرسش که شهر چگونه خاطرهٔ جمعیِ یک ملت را در خود نگاه می‌دارد.', date: 'بهار ۲۵۸۵', author: 'حافظ باباشاهی' },
  { slug: 'letter-future', tag: 'یادداشت آزاد', title: 'نامه‌ای به خوانندهٔ آینده', excerpt: 'یادداشتی خطاب به آن‌که سال‌ها بعد این سطرها را می‌خواند؛ از امیدها و بیم‌های امروزِ ما.', date: 'بهار ۲۵۸۵', author: 'امین نایب‌پور' },
];
