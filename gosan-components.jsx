...
const GOSAN_POSTS = [
  ...
  { slug: 'azarkeyvani-creation-myth', tag: 'جستار', title: 'تأویلی آذرکیوانی از اسطورۀ آفرینش زردشتی در کتاب دبستان مذاهب', excerpt: 'بررسی روایت دبستان مذاهب از اسطورۀ آفرینش زردشتی و تأویل منسوب به جاماسب حکیم؛ روایتی که سرچشمهٔ آن نه متون زردشتی، که نوشته‌های ملل‌ونحل‌نویسان اسلامی است و تأویلش از اندیشه‌های آذرکیوانی برمی‌خیزد.', date: 'تابستان ۲۵۸۵', author: 'پروانه گشتاسب' },
  { slug: 'who-is-the-gosan', tag: 'جستار', title: 'گوسان کیست؟ سنت گوسانان در ایران باستان', excerpt: 'به‌زودی.', date: 'تابستان ۲۵۸۵', author: 'احسان شواربی' },
  { slug: 'farabi-music-politics', tag: 'جستار', title: 'موسیقی و سیاست نزد فارابی', excerpt: 'به‌زودی.', date: 'تابستان ۲۵۸۵', author: 'امین نایب‌پور' },
];
...
const GOSAN_SUMMARIES = {
  ...
  "note-for-gosan": "این یادداشت به مناسبت آغاز به کار گاهنامهٔ گوسان نوشته شده و نویسنده در آن، دعوت از او به همکاری با نشریه را دست‌مایهٔ یادآوریِ «روزنامهٔ کاوه» می‌کند؛ نشریه‌ای که سیدحسن تقی‌زاده در گیرودار جنگ جهانی اول در برلن بنیاد نهاد.",
