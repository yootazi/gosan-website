...
const AUTHOR_BIOS = {
  'یلدا زمانی': 'رهبر ارکستر ایرانی–آلمانی مقیم برلین و متخصص موسیقی معاصر؛ دستیار رهبر ارکستر آنسامبل اینترکنتمپورن در فیلارمونی پاریس و بنیان‌گذار ارکستر مجلسی اِلبه در هامبورگ. مدیرمسئول و سردبیر گاهنامهٔ گوسان.',
  'حافظ باباشاهی': 'پیانیستِ تک‌نواز و همنواز، آموختهٔ دانشگاه موسیقی وین؛ بنیان‌گذار جشنوارهٔ آواز کلاسیک «وینر لیدر هربست» و مدرس کلاس پیانو در کنسرواتوار ریشارد واگنر وین. از بنیان‌گذاران گاهنامهٔ گوسان.',
  ...
  'امین نایب‌پور': 'پژوهشگر نگارگری و هنرهای تصویری ایران.',
  'سهراب لبیب': 'پیانیست و مدرس موسیقی.',
  'فرناز مدرسی‌فر': 'فرناز مدرسی‌فر، آهنگساز، نوازندۀ سنتور و شاعر ایرانی-فرانسوی، متولد ۱۳۶۸ (۱۹۸۹ میلادی) در تهران است. او پس از تحصیل در هنرستان عالی موسیقی و دانشگاه تهران، در زمینۀ ردیف دستگاهی و بداهه‌نوازی سنتور تخصص یافت و رتبۀ نخست نوازندگی را کسب کرد. وی پس از اقامت در پاریس، تحصیلات خود را ادامه داد و موفق به اخذ چندین دیپلم و مدرک کارشناسی ارشد در رشته‌های آهنگسازی، بداهه‌نوازی و موسیقی‌شناسی شد.\nمدرسی‌فر که به عنوان پژوهشگر و هنرمند مقیم (پانسیونر) در آکادمی فرانسه در رم (ویلا مدیچی) برای سال‌های ۲۰۲۵–۲۰۲۶ انتخاب شده است، از برگزیدگان کارگاه آهنگسازی ژرژ آپرگیس و همچنین برندۀ چندین جایزۀ ملی و بین‌المللی است؛ از جمله جایزۀ آلن لوویه، بیست‌وچهارمین جایزۀ بزرگ دانش‌آموزی آهنگسازان (۲۰۲۳) و جایزۀ آهنگسازی کلود آریو از انجمن ساسم (SACEM – ۲۰۲۴).\nوی با گروه‌ها و جشنواره‌های متعددی از جمله آرس نُوا (Ars Nova)، رِشِرش (Recherche)، سیاژ (Sillage)، خانۀ موسیقی معاصر و جشنوارۀ لِزارک (Festival des Arcs) همکاری داشته و به‌عنوان هنرمند مقیم فعالیت کرده است.\nاو که به دعوت بنیاد روایومون (Royaumont) در برنامۀ «صداهای نو» (Voix Nouvelles) حضور داشته، با هنرمندان برجسته‌ای چون بارتاباس و همایون شجریان همکاری کرده و اجراهای متعددی در رادیو فرانس‌موزیک، تئاتر شهر پاریس و بسیاری از جشنواره‌های معتبر داشته است.\nفرناز مدرسی‌فر همچنین از برگزیدگان آکادمی آهنگسازان زن جوان در ارکستر مجلسی پاریس است و آثار او در مراکز مهمی چون فیلارمونی پاریس، تئاتر شاتله، اپرای رنس، بوزار در بروکسل، اپرای نانت و آنژه، تئاتر و اودیتوریوم پواتیه (TAP) و بنیاد گلبنکیان در لیسبون به روی صحنه رفته است.',
};
