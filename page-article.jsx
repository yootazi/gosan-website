...
const AUTHOR_BIOS = {
  ...
  'فرناز مدرسی‌فر': 'فرناز مدرسی‌فر آهنگساز، نوازندهٔ سنتور و شاعر ایرانی–فرانسوی، متولد ۱۳۶۸ (۱۹۸۹) در تهران است. او پس از تحصیل در هنرستان موسیقی دختران و دانشکدهٔ هنرهای زیبای دانشگاه تهران، در نوازندگی سنتور و کارشناسی موسیقی فارغ‌التحصیل شد و رتبهٔ نخست نوازندگی را کسب کرد. پس از اقامت در پاریس، چندین دیپلم و مدرک کارشناسی ارشد در آهنگسازی، بداهه‌نوازی و موسیقی‌شناسی دریافت کرد. او هنرمند مقیم (پانسیونر) آکادمی فرانسه در رم (ویلا مدیچی) برای سال‌های ۲۰۲۵ و ۲۰۲۶ و برندهٔ چندین جایزهٔ ملی و بین‌المللی است، از جمله جایزهٔ آهنگسازی آلان لوویه، جایزهٔ سوپرفونیک (۲۰۲۳)، جایزهٔ کلود آریو از SACEM (۲۰۲۴) و جایزهٔ بنیاد سینیاتور و SACD (۲۰۲۶). آثار او با آنسامبل‌هایی چون اینترکنتمپورن، آرس نوا و رشرش و در سالن‌هایی مانند فیلارمونی پاریس، تئاتر شاتله و بنیاد گولبنکیان لیسبون اجرا شده است.',
};
