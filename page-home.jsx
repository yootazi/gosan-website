...
function HomePage({ lang = 'fa', onToggleLang }) {
  ...
  const latest = ['who-is-the-gosan', 'azarkeyvani-creation-myth', 'music-totalitarian-regimes', 'interview-farnaz-modarresifar', 'herzfeld-german-archives', 'between-two-defeats', 'beyzaie-myth-symbolic-action'].map(P);
